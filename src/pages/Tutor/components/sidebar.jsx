    ...
    return(
        <>
            <div className="w-full h-screen flex">
                <div className="w-[22%] h-full flex flex-col bg-[#EAF3EE] fixed left-0 top-0">
                        ...
                        <ul className="flex flex-col items-center space-y-2.5 mt-2 text-[#4A5C52] poppins-font normal">
                            <li className="w-[95%] font-semibold text-[12.5px] transition-all hover:bg-[#F4F6F5] hover:shadow-sm">
                                <NavLink to="/learner_dashboard" end className={({isActive}) => `flex space-x-3 flex justify-left items-center p-3 ${isActive ? 'bg-[#FFFFFF] hover:rounded-lg hover:bg-[#F4F6F5]' : ''}`}>
                            ...
                            <li className="w-[95%] font-semibold text-[12.5px] transition-all hover:bg-[#F4F6F5] hover:shadow-xs">
                                <NavLink to="/courses" className={({isActive}) => `flex space-x-3 flex justify-left items-center p-3 ${isActive ? 'bg-[#FFFFFF] hover:rounded-lg hover:bg-[#F4F6F5]' : ''}`}>
                                    <LuBookOpen  className="text-[15px]"/> 
                                    <p>Courses</p>
                                </NavLink> 
                            </li>
                            <li className="w-[95%] font-semibold text-[12.5px] transition-all hover:bg-[#F4F6F5] hover:shadow-xs">
                                <NavLink to="#" className={({isActive}) => `flex space-x-3 flex justify-left items-center p-3 ${isActive ? 'bg-[#FFFFFF] hover:rounded-lg hover:bg-[#F4F6F5]' : ''}`}>
                ...
                <div className="w-[78%] h-full flex flex-col ml-[22%]">
                    <div className="w-[78%] fixed top-0 right-0 bg-white z-10 border h-15 flex px-5 items-center space-x-5">
